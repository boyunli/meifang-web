"""
Django settings for meifangsite project.
...
SECRET_KEY = 'bex$)klsr$&z%($zgz%ua(xmgbpr5p6@ado8nu*+15kw)suj*v'
...
WSGI_APPLICATION = 'meifangsite.wsgi.application'
